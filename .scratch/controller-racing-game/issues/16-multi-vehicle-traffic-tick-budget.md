...
- [ ] Crash/ghost behavior is correct in traffic (engine-seam test: a colliding vehicle resets to the centerline; a ghost vehicle cannot be re-collided; racing vehicles remain visible in scans, ghosts absent)
